...
plt = ggplot(industry_house_t_tbl, aes(x = p_value, y = t_statistic)) +
  geom_point(aes(text = paste0("Industry: ", industry_name))) +
  scale_y_log10() +
  scale_x_continuous(breaks = seq(from = 0, to = 1, by = .05)) +
  theme(axis.text.x = element_text(angle = -90, hjust = 0)) +
  ggtitle("T Test Statistic over p-value")
...
plt = ggplot(industry_senate_t_tbl, aes(x = p_value, y = t_statistic)) +
  geom_point(aes(text = paste0("Industry: ", industry_name))) +
  scale_y_log10() +
  scale_x_continuous(breaks = seq(from = 0, to = 1, by = .05)) +
  theme(axis.text.x = element_text(angle = -90, hjust = 0)) +
...
for (cty in full_use_ctys){
  ...
  country_house_t_tbl = rbind(country_house_t_tbl,
                              c(
                                    country_name = cty,
...
colnames(country_house_t_tbl) = c("country_name",
                                      "test_statistic",
                                      "p_value",
                                      "average_total_donation",
                                      "CI.0",
...
country_house_t_tbl = country_house_t_tbl %>% 
  mutate(
...
plt = ggplot(country_house_t_tbl, aes(x = p_value, y = average_total_donation)) +
...
plt = ggplot(country_house_t_tbl, aes(x = p_value, y = test_statistic)) +
  geom_point(aes(text = paste0("Country: ", country_name))) +
  scale_y_log10() +
  scale_x_continuous(breaks = seq(from = 0, to = 1, by = .05)) +
  theme(axis.text.x = element_text(angle = -90, hjust = 0)) +
...
for (cty in full_use_ctys){
  ...
  country_senate_t_tbl = rbind(country_senate_t_tbl,
                              c(
                                    country_name = cty,
                                    test_statistic = curr_test$statistic,
                                    p_value = curr_test$p.value,
...
colnames(country_senate_t_tbl) = c("country_name",
                                      "test_statistic",
                                      "p_value",
                                      "average_total_donation",
                                      "CI.0",
...
country_senate_t_tbl = country_senate_t_tbl %>% 
  mutate(
         test_statistic = parse_number(test_statistic),
         p_value = parse_number(p_value),
         average_total_donation = parse_number(average_total_donation),
...
plt = ggplot(country_senate_t_tbl, aes(x = p_value, y = average_total_donation)) +
  geom_point(aes(text = paste0("Country: ", country_name))) +
  scale_y_log10() +
  scale_x_continuous(breaks = seq(from = 0, to = 1, by = .05)) +
  theme(axis.text.x = element_text(angle = -90, hjust = 0)) +
...
plt = ggplot(country_senate_t_tbl, aes(x = p_value, y = test_statistic)) +
  geom_point(aes(text = paste0("Country: ", country_name))) +
  scale_y_log10() +
  scale_x_continuous(breaks = seq(from = 0, to = 1, by = .05)) +
  theme(axis.text.x = element_text(angle = -90, hjust = 0)) +
